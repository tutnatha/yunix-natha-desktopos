...
public abstract class QBFCompareEnum {
    ...
    public final static QBFCompareEnum COMP_RE = new QBFCompareEnum(3, "qbf.re") {
        @Override
        public String getExpression(String sField, String sSQLValue) { return " UPPER(" + sField + ") LIKE " + sSQLValue.toUpperCase() ; }
    };
    ...
    public final static QBFCompareEnum COMP_CATEGORY = new QBFCompareEnum(3, "qbf.equals") {
        @Override
        public String getExpression(String sField, String sSQLValue) { return  sField + " = " + sSQLValue +" OR categories.parentid="+sSQLValue; }
    };
