 ...
 * @author jack gerrard
 */
public class StockManagementOnlyIn extends JPanel implements JPanelView {
     ...
     * @param app 
    */
    public StockManagementOnlyIn(AppView app) {
...
//        m_LocationsModel.setSelectedFirst();
    ...
    public void showStockTable() {
        ...
        if (pId != null) {
            stockModel = new StockManagementOnlyIn.aStockTableModel(getProductOfName(pId));
...
*/        
    ...
    private void m_jListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jListActionPerformed
        ...
        ProductInfoExt prod = JProductFinder.showMessage(StockManagementOnlyIn.this, m_dlSales);
        if (prod != null) {
