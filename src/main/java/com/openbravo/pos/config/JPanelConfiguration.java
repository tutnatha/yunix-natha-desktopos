...
public class JPanelConfiguration extends JPanel implements JPanelView {
    ...
    public JPanelConfiguration(AppProperties props) {
        ...
        panel = new JPanelConfigERP();
        m_panelconfig.add(panel);
        jPanelConfigERP.add(panel.getConfigComponent());
    ...
    private void initComponents() {
        ...
        jPanelConfigERP = new javax.swing.JPanel();
        ...
        jPanelConfigERP.setBackground(new java.awt.Color(255, 255, 255));
        jPanelConfigERP.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jPanelConfigERP.setPreferredSize(new java.awt.Dimension(0, 400));
        jPanelConfigERP.setLayout(new javax.swing.BoxLayout(jPanelConfigERP, javax.swing.BoxLayout.LINE_AXIS));
        jTabbedPane1.addTab("ERP", jPanelConfigERP);
    ...
    private javax.swing.JPanel jPanelConfigERP;
