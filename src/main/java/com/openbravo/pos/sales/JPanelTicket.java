...
public abstract class JPanelTicket extends JPanel implements JPanelView, BeanFactoryApp, TicketsEditor {
    ...
    protected boolean ticketlab = false;
    ...
    public JPanelTicket() {
        ...
        TicketNoLabel.setVisible(ticketlab);
    }
...
// Configuration>Peripheral options        
    ...
    protected abstract void resetTicketType();
    ...
    public void setActiveTicket(TicketInfo oTicket, Object oTicketExt) {
        ...
        if (m_oTicket != null) {            
            ...
            m_oTicket.setTicketRefundNumber(ticketnumber.getText());
        ...
        if (m_oTicket == null) {        
            ...
            for (int i = 0; i < m_oTicket.getLinesCount(); i++) {
                if (m_oTicket.getTicketType() == 1) {
                    double multP = m_oTicket.getLine(i).getMultiply();
                    if (multP > 0) {
                        multP = multP *(-1.0);
                    }
                    if (multP == 0) {
                    ...
                    m_oTicket.getLine(i).setMultiply(multP);
                }
...
//    private void printPartialTotals(){
    ...
    protected void addTicketLine(TicketLineInfo oLine) {  
            ...
            String ticketaddline = "ticket.addline";
            if(m_oTicket.getTicketType() == 1)
            {
                ticketaddline = "";
            }
                  
          if (executeEventAndRefresh(ticketaddline, new ScriptArg("line", oLine)) == null) {        
...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        TicketNoLabel = new javax.swing.JPanel();
        ...
        jTextField1.setText("Número de Ticket");
        ...
        ticketnumber.setPreferredSize(new java.awt.Dimension(16, 27));

        javax.swing.GroupLayout TicketNoLabelLayout = new javax.swing.GroupLayout(TicketNoLabel);
        TicketNoLabel.setLayout(TicketNoLabelLayout);
        TicketNoLabelLayout.setHorizontalGroup(
            TicketNoLabelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(TicketNoLabelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jTextField1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(ticketnumber, javax.swing.GroupLayout.DEFAULT_SIZE, 297, Short.MAX_VALUE)
                .addContainerGap())
        );
        TicketNoLabelLayout.setVerticalGroup(
            TicketNoLabelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(TicketNoLabelLayout.createSequentialGroup()
                .addGap(43, 43, 43)
                .addGroup(TicketNoLabelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTextField1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel4.add(TicketNoLabel, java.awt.BorderLayout.PAGE_END);
    ...
    private void m_jListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jListActionPerformed
        resetTicketType();
        ProductInfoExt prod = JProductFinder.showMessage(JPanelTicket.this, dlSales, m_App);  
        if (prod != null) {
...
//                            " : " + "</b>" + checkProduct.getLocation() + "<br>" +
    ...
    private javax.swing.JPanel TicketNoLabel;
