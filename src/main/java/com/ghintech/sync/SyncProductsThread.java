 ...
 * @author sergio
 */
public class SyncProductsThread extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                stopLoop = sent == true ? products.getWsProductTypeInterval() : 0.25;
                ...
                Logger.getLogger(SyncProductsThread.class.getName()).log(Level.SEVERE, null, ex);
