...
public class Order implements java.io.Serializable {
    ...
    private com.ghintech.sync.externalsales.BPartner businessPartner;
    private com.ghintech.sync.externalsales.OrderLine[] lines;
    private com.ghintech.sync.externalsales.OrderIdentifier orderId;
    private com.ghintech.sync.externalsales.Payment[] payment;
    private int state;
    ...
    public Order(
            com.ghintech.sync.externalsales.BPartner businessPartner,
            com.ghintech.sync.externalsales.OrderLine[] lines,
            com.ghintech.sync.externalsales.OrderIdentifier orderId,
            com.ghintech.sync.externalsales.Payment[] payment,
            int state) {
     ...
     */
    public com.ghintech.sync.externalsales.BPartner getBusinessPartner() {
        return businessPartner;
    }
     ...
     */
    public void setBusinessPartner(com.ghintech.sync.externalsales.BPartner businessPartner) {
        this.businessPartner = businessPartner;
    }
     ...
     * @return lines
     */
    public com.ghintech.sync.externalsales.OrderLine[] getLines() {
        return lines;
    }
     ...
     * @param lines
     */
    public void setLines(com.ghintech.sync.externalsales.OrderLine[] lines) {
        this.lines = lines;
    }
     ...
     * @return orderId
     */
    public com.ghintech.sync.externalsales.OrderIdentifier getOrderId() {
        return orderId;
    }
     ...
     * @param orderId
     */
    public void setOrderId(com.ghintech.sync.externalsales.OrderIdentifier orderId) {
        this.orderId = orderId;
    }
     ...
     * @return payment
     */
    public com.ghintech.sync.externalsales.Payment[] getPayment() {
        return payment;
    }
     ...
     * @param payment
     */
    public void setPayment(com.ghintech.sync.externalsales.Payment[] payment) {
        this.payment = payment;
    }
