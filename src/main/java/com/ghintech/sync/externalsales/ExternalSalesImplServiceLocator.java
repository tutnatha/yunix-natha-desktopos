...
public class ExternalSalesImplServiceLocator extends org.apache.axis.client.Service implements com.ghintech.sync.externalsales.ExternalSalesImplService {
    ...
    private java.lang.String ExternalSales_address = "http://localhost:8088/ADInterface/services/ExternalSales";
    ...
    public com.ghintech.sync.externalsales.ExternalSalesImpl getExternalSales(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ghintech.sync.externalsales.ExternalSalesSoapBindingStub _stub = new com.ghintech.sync.externalsales.ExternalSalesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ghintech.sync.externalsales.ExternalSalesImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ghintech.sync.externalsales.ExternalSalesSoapBindingStub _stub = new com.ghintech.sync.externalsales.ExternalSalesSoapBindingStub(new java.net.URL(ExternalSales_address), this);
                _stub.setPortName(getExternalSalesWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8088/ADInterface/services/ExternalSales", "ExternalSalesImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8088/ADInterface/services/ExternalSales", "ExternalSales"));
        }
