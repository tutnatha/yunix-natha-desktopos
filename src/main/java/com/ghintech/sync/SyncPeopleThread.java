...
public class SyncPeopleThread extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                stopLoop = sent == true ? people.getWsPeopleTypeInterval() : 0.25;
                ...
                Logger.getLogger(SyncPeopleThread.class.getName()).log(Level.SEVERE, null, ex);
            }
            c++;
        }
